    ...
    <nav id="mainav" class="clear"> 
      ...
      <ul class="clear">
        ...
        <li><a class="drop" href="#">Pages</a>
          <ul>
            <li><a href="pages/gallery.html">New words</a></li>
            <li><a href="pages/portfolio.html">Vocabulary Lists</a></li>
            <li><a href="pages/full-width.html">Add Words</a></li>
            <li><a href="pages/sidebar-left.html">Evaluation</a></li>
...
<div class="wrapper">
  <div id="slider">
    <div id="slide-wrapper" class="rounded clear"> 
     ...
     <!-- <figure id="slide-1"><a class="view" href="#"><img src="../images/demo/slider/1.png" alt=""></a>
         <a class="view" href="#"><img alt="" src="../images/demo/slider/img1.jpg"></a>   
           </figure> --> 
  ...
  <div  style="color: #FF0000;">
    ...
    <td>
      <table>
        <tr>
            <a class="view" href=""><img alt="" src="../images/demo/slider/Maryam.jpg"></a>
    ...
    <td><a class="view" href="#"><img alt="" src="../images/demo/slider/img1.jpg"></a> </td>
    </tr>
        </table>  
  </div>
